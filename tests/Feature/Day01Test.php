...
use App\Days\Day1\Solver;
use App\Helpers\InputParser;
use Tests\TestCase;
...
class Day01Test extends TestCase
{
    ...
    /** @test */
    public function it_solves_short_input()
    {
        // given,
        $solver = new Solver(static::INPUT_SHORT);

        // when
        $result = $solver->solveForTwo();
    ...
    /** @test */
    public function it_solves_long_input()
    {
        // given,
        ...
        $this->assertEquals(55776, $result);
    }
