...
use App\Days\Day2\Line;
use App\Days\Day2\LineParser;
use App\Days\Day2\Solver;
use Tests\TestCase;
...
class Day02Test extends TestCase
{
    ...
    const LONG_INPUT = "6-7 z: dqzzzjbzz
...
11-16 r: rrrrrrrrrrrrrrrlr";
    ...
    /** @test */
    public function line_object_validates_data_correctly()
    {
        // given
        $line = new Line(2, 3, 'a', '2dfsada');
    ...
    /** @test */
    public function it_parses_and_validates_short_string()
    {
        $line1 = LineParser::parse(static::SHORT_INPUT[0]);
        $this->assertTrue($line1->validate());

        $line2 = LineParser::parse(static::SHORT_INPUT[1]);
        $this->assertFalse($line2->validate());

        $line3 = LineParser::parse(static::SHORT_INPUT[2]);
        $this->assertTrue($line3->validate());
    }

    /** @test */
    public function it_solves_for_short_input()
    {
        // given
        // short input

        // when
        $result = Solver::solve(static::SHORT_INPUT);
    ...
    /** @test */
    public function it_solves_for_long_input()
    {
        // given
        $inputParsed = explode(PHP_EOL, static::LONG_INPUT);

        // when
        $result = Solver::solve($inputParsed);
